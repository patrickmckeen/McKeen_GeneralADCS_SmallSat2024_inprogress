...
public:
    ...
    BEFORE_OUTPUT_FORM trajOptBefore(VECTOR_INFO_FORM vecs_w_time,int N, TIME_FORM time_start, TIME_FORM time_end, arma::vec x0, int bdotOn);
    AFTER_OUTPUT_FORM trajOptAfter(VECTOR_INFO_FORM vecs_w_time,int N, TIME_FORM time_start, TIME_FORM time_end, ALILQR_OUTPUT_FORM alilqrOut);
    ...
    arma::vec smartbdot_rawmtq_finder(double dt0,arma::vec wk, double nB2, arma::vec ECIvk, arma::vec ECIvkp1, arma::vec3 satvk, arma::vec3 Bbody,SMARTBDOT_SETTINGS_FORM sbSettings);
